...
#C file write time: 2024-11-29  18:30:39
data.SS
control.SS
...
-1 # min year for sdreport outputs (-1 for styr); #_1987
...
-1 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1732901453
